...
--------------------------------------------------------------------------------
strides = [8, 16, 32];global_max = True;epochs=50
...
strides = [8, 16, 32];global_max = True;epochs=100
...
strides = [8, 16, 32];global_max = True;epochs=150
...
--------------------------------------------------------------------------------
strides = [8, 16, 32];global_max = False;epochs=50
...
strides = [8, 16, 32];global_max = False;epochs=100
...
strides = [8, 16, 32];global_max = False;epochs=150
...
if len(strides) == 1:
    ...
    wsize = [0.08819445, 0.10633333, 0.13333333, 0.15317307, 0.17440218, 0.20163462, 0.24223214, 0.26958334, 0.30874997]
    hsize = [0.11208335, 0.13878788, 0.16133334, 0.1804902, 0.20456521, 0.23355073, 0.25911114, 0.2886842, 0.33972222]
elif len(strides) == 5:
...
# 通过聚类生成先验框
# gen_anchorv2(FruitsNutsDataset(dir_data,classes),8)
# exit(0)
