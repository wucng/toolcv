...
from toolcv.utils.data.data import DataDefine, HumanVehicleDataset
...
if len(strides) == 1:
    ...
    wsize = [0.00965111, 0.01878812, 0.0301322, 0.04399336, 0.0605186, 0.0800487,
             0.10177921, 0.12712793, 0.15563649, 0.19203337, 0.23260292, 0.2817125,
             0.35218003, 0.45377043, 0.63676757]
    hsize = [0.02271463, 0.04220052, 0.06211967, 0.08457883, 0.11022929, 0.14085189,
             0.1780644, 0.22267088, 0.28027186, 0.3542807, 0.44264, 0.5380253,
             0.64003676, 0.78951824, 0.9275224]
elif len(strides) == 5:
...
h, w = 512, 512
resize = (h, w)
# dir_data = r"../input/human-vehicle-detection/human_vehicle_detection"
...
# -------------------data-------------------
data = DataDefine(dir_data, classes, batch_size, resize, 0.9)
