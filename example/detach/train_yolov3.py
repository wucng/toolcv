...
from toolcv.tools.utils import train_yolov3 as train, predict_yolov3 as predict
...
def main(training=True, visual=True):
    ...
    model = Yolov3simple('resnet34', True, num_anchors, num_classes, strides).to(device)
    ...
    if training:
        ...
        for img_path in img_paths:
            info = predict(anchors, model, img_path, test_transform, resize, device, visual,
                           strides, fix_resize, mode,conf_threshold=0.3)
            print(info)
