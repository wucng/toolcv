...
def main(training=True, visual=False):
    ...
    _model = SSDsimpleMS('dla34', True, num_anchors, num_classes, strides,dropout,freeze_at)
    ...
    if training:
        ...
        predict_ssdMS(anchors, _model, img_paths, test_transform, resize, device, visual, strides, fix_resize=True,
