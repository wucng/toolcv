...
def main(training=True, visual=False):
    ...
    _model = Yolov3simple('dla34', True, num_anchors, num_classes, strides,dropout, 5, freeze_at)
    model = DetecteModel(_model, None, epochs=epochs, warpstep=1000, lr=lr, lrf=0.1, weight_decay=weight_decay,
                         ...
                         box_norm=box_norm,
                         multiscale=multiscale, reduction=reduction)
    ...
    if training:
        ...
        predict_yolov3(anchors, _model, img_paths, test_transform, resize, device, visual, strides, fix_resize=True,
