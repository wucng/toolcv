...
def main(training=True, visual=False):
    ...
    model = DetecteModel(_model, None, epochs=epochs, warpstep=1000, lr=lr, lrf=0.1, weight_decay=weight_decay,
                         ...
                         box_norm=box_norm, multiscale=multiscale, reduction=reduction)
    ...
    if training:
        ...
        predict_fcos(_model, img_paths, test_transform, resize, device, visual, strides, fix_resize=True, mode=mode,
