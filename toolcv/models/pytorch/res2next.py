# https://github.com/Res2Net/Res2Net-PretrainedModels/blob/master/res2next.py
...
def res2next50(pretrained=False, **kwargs):
    ...
    model = Res2NeXt(Bottle2neckXSE, layers = [3, 4, 6, 3], baseWidth = 4, cardinality=8, scale = 4, num_classes=1000)
    if pretrained:
