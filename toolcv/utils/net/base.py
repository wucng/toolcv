...
from toolcv.utils.coco_evalute.engine import evaluate_do
...
class _BaseNetV2(nn.Module):
    def __init__(self, model, num_classes, img_shape=(), anchors=None, strides=4, epochs=10, lr=5e-4, weight_decay=5e-5,
        ...
        self.each_batch_scheduler = each_batch_scheduler

        self.scaler = torch.cuda.amp.GradScaler(enabled=enable_gradscaler & use_amp)
