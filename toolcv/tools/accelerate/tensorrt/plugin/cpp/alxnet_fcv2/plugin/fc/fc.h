...
namespace nvinfer1
{
    class FcPlugin: public IPluginV2IOExt
    {
        public:
            explicit FcPlugin();

            // FcPlugin(float *weights,int len_weight,float *bias,int len_bias);
            FcPlugin(float *weights,float *bias);
    ...
    class FcPluginCreator : public IPluginCreator
    {
        public:
            ...
            */
            ...
            // IPluginV2IOExt* createPlugin(const char* name, const PluginFieldCollection* fc,Weights &weights,Weights &bias);
