...
def populate_network(network, weights=None, ModelData=None):
    ...
    relu6 = network.add_plugin_v2(inputs=[input_layer], plugin=get_trt_plugin("CustomClipPlugin"))
    relu6.get_output(0).name = ModelData.OUTPUT_NAME
    network.mark_output(relu6.get_output(0))
