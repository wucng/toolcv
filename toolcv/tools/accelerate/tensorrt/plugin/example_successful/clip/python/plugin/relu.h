...
namespace nvinfer1
{
    class ReluPlugin: public IPluginV2IOExt
    {
        public:
            ...
            ReluPlugin(float mClipMin, float mClipMax);
            ...
            */
            ...
            int input_size_;
        private:
            void forwardGpu(const float *const * inputs, float* output, cudaStream_t stream, int batchSize = 1,float mClipMin=0.0f, float mClipMax=6.0f);
