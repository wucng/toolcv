...
class I2RBlock(nn.Module):
    ...
    def forward(self, input):
        ...
        if self.identity:
            shape = fbn_tensor.shape
            id_tensor = fbn_tensor[:,:shape[1]//self.identity_div,:,:]
