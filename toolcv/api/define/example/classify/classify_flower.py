...
from toolcv.api.define.utils.model.detecte.backbone.backbone import RandomModel, Resnet50x,Resnet50l
...
#     # baug.ResizeFixMinAndRandomCropV2AndPatch([256, 300, 400, 500, 600], [0.5, 0.6, 0.7, 0.8, 0.9]),
#     baug.ResizeFixMinAndRandomCropV2AndPatch([200, 224, 256, 300], [0.7, 0.8, 0.9]),
#     aug.Resize(*resize),
...
dataloader = LoadDataloader(train_dataset, test_dataset, 0.1, batch_size, {})
train_dataLoader, val_dataLoader = dataloader.train_dataloader(), dataloader.val_dataloader(batch_size)
...
model = Resnet50l(3, num_classes, freeze_at=0, stride=strides, do_cls=True).to(device)
