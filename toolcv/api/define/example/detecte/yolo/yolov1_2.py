"""
1、网络使用的是 centernet 网络 stride=4
...
from mmdet.models.losses import GaussianFocalLoss, L1Loss, FocalLoss, CrossEntropyLoss, QualityFocalLoss
...
class Yolov1(_BaseNetV2):
    ...
    def train_step(self, batch, step):
        ...
        bs, _, fh, fw = centerness_pred.shape
        # get_target
        # target
        ...
        # # 会自动添加 sigmoid
        # loss_center_heatmap = QualityFocalLoss()(centerness_pred[keep], centerness_target[keep], avg_factor=avg_factor)
